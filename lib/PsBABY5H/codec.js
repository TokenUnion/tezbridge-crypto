...
export function bytesConcat(x             , y             ) {
...
export function bs58checkEncode(input             , prefix_info                      ) {
...
export function bs58checkDecode(input         , prefix              ) {
...
export function bs58checkPrefixPick(input         )                                     {
...
export function getContractHexKey(contract         ) {
...
export function encodeZarithUInt(value         ) {
...
export function encodeZarithInt(value         ) {
  const num = new BN(value, 10)
...
export function toTzStrValue(input         ) {
  const len_mapping = {
    [44]() {
...
export function toTzBytes(source         , is_key_hash           = false) {
...
export function encodeRawBytes(input            )          {
  const rec = (input            )          => {
    const result                 = []
